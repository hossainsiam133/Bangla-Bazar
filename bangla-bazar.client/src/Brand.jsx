...
function Brand() {
    ...
    const fetchProductsByBrand = async () => {
        try {
            ...
            console.log('Filtered products for', brandName, ':', filteredProducts);
        ...
        <>
            ...
            <div className="container py-4 py-md-5">
                ...
                <div className="brand-header mb-4">
                    ...
                    <div>
                        <h2 className="fw-bold mb-1">{brandName}</h2>
                ...
                {products.length > 0 ? (
                    ...
                    <div className="text-center py-5">
                        <p className="text-muted fs-5">No products found for this brand.</p>
